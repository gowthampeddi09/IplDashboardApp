...
/*   TeamMatches extends Component {
  ...
  getTeamMatchesData = async () => {
    ...
    this.setState({matchDetails: getUpdatedMatchesData, isLoading: false})
    console.log(getUpdatedMatchesData.latestMatchDetails.id)
    console.log(getUpdatedMatchesData.recentMatches[0].id)
  }
